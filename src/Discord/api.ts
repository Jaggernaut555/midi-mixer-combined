...
export class DiscordApi {
  ...
  public async bootstrap(): Promise<void> {
    $MM.setSettingsStatus("DiscordStatus", "Connecting to Discord...");
    ...
    $MM.setSettingsStatus("DiscordStatus", "Syncing voice settings...");
    this.settings = await this.rpc.getVoiceSettings();
    $MM.setSettingsStatus("DiscordStatus", "Connected");
    ...
    this.buttons = {
      ...
      [DiscordButton.ToggleSilenceWarning]: new ButtonType(
        ...
        {
          name: "Discord: Toggle muted mic warning",
          active: Boolean(
      ...
      [DiscordButton.ToggleNoiseSuppression]: new ButtonType(
        ...
        {
          name: "Discord: Toggle noise reduction",
          active: Boolean(
      ...
      [DiscordButton.ToggleEchoCancellation]: new ButtonType(
        ...
        {
          name: "Discord: Toggle echo cancellation",
          active: Boolean(
      ...
      [DiscordButton.ToggleAutomaticGainControl]: new ButtonType(
        ...
        {
          name: "Discord: Toggle automatic gain control",
          active: Boolean(
  ...
  private async authorize() {
    $MM.setSettingsStatus("DiscordStatus", "Waiting for user authorisation...");
